    ...
    <div className="mx-auto flex w-full min-h-0 max-w-4xl flex-1 flex-col gap-4 overflow-y-auto p-6">
      ...
      >
        <textarea
          ...
          rows={3}
          className="resize-none rounded-md border border-[var(--border)] bg-[var(--panel-alt)] px-4 py-3 text-[var(--foreground)] outline-none transition-colors focus:border-[var(--accent)]"
        />
        <button
          type="submit"
      ...
      {isLoading && (
        <div className="flex flex-1 animate-pulse items-center justify-center rounded-lg border border-[var(--border)] bg-[var(--panel-bg)] p-12 text-[var(--text-secondary)]">
      ...
      {result && !isLoading && (
        <div className="flex flex-col gap-4 rounded-lg border border-[var(--border)] bg-[var(--panel-bg)] p-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="rounded-md border border-[var(--border)] bg-[var(--panel-alt)] px-4 py-2 text-sm font-medium text-[var(--foreground)] transition-colors hover:border-[var(--accent)]"
            >
              💾 Pobierz
            </button>
            <button
